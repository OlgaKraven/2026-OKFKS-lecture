...
const introductionTheory: Record<string, string> = {
  's07-01-quality-and-failures': 'Качество системы оценивают по наблюдаемому выполнению требований. В терминологии тестирования ошибка относится к действию человека, дефект — к артефакту, а отказ — к недоступной или неверно выполненной функции.',
