...
Адаптивный сайт-презентация для 7-го и 8-го семестров. Курс содержит 7 тем, по 86 экранов в каждой: 81 учебный и 5 служебных.

## Учебный формат

- предметные тезисные заголовки вместо многократного повторения названия вопроса;
- чередование опорного определения, логической последовательности, разбора ситуации, решения, антиошибки и воспроизведения по памяти;
- крупные блоки для конспекта: условия, связи, свидетельства, границы применения и критерии;
- лабораторный маршрут из восьми разных этапов — от паспорта работы до вывода и ограничений;
- переходы между вопросами и задания на объяснение своими словами, чтобы записи образовывали связную систему.
